...
data_train = train.data.numpy().reshape(train.data.shape[0], -1); target_train = train.targets.numpy()
data_test = test.data.numpy().reshape(test.data.shape[0], -1); target_test = test.targets.numpy()
