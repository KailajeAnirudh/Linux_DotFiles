...
plt.semilogy(np.arange(nesterov_loss.shape[1]), nesterov_loss[ls==100], label = 'Nesterov Gradient Descent')
plt.semilogy(np.arange(SGD_loss.shape[1]), SGD_loss[0], label = 'SGD')
plt.semilogy(np.arange(SGD_nesterov_loss.shape[1]), SGD_nesterov_loss[0], label = 'Nesterov SGD')
plt.xlabel('Weight Updates')
