...
plt.savefig(f'/home/anirudhkailaje/Documents/01_UPenn/01_ESE5460/02_Homework/04_Homework4/src/report/NesterovSGD/Nestereov Stochastic Gradient Descent with Batch Size{batch_sizes[i]}.png')
plt.close()
