...
plt.savefig('/home/anirudhkailaje/Documents/01_UPenn/01_ESE5460/02_Homework/04_Homework4/src/report/Gradient Descent.png')
plt.show()
...
for i in range(len(nesterov_momentum_factors)):
    ...
    plt.title(f'Nesterov Gradient Descent with Momentum Factor{nesterov_momentum_factors[i]}.png')
    plt.savefig(f'/home/anirudhkailaje/Documents/01_UPenn/01_ESE5460/02_Homework/04_Homework4/src/report/Nesterov Gradient Descent with Momentum Factor{nesterov_momentum_factors[i]}.png')
    plt.close()
