...
resolutions = [np.ones(3)*0.65, np.ones(3)*0.35, np.ones(3)*0.21, np.ones(3)*0.1]
total_time = 0
for filename in filenames:
    ...
    for resolution in resolutions: # (x,y,z) resolution of discretization, shape=(3,).
        ...
        for astar in astar_condition:
            ...
            ax.set_title(f'Resolution: {resolution}, Expansion: {node_expanded}, Time: {end_time-start_time:.2f}s, A* = {astar}')
