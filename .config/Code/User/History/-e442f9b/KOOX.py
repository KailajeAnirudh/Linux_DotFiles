...
def CollocationConstraintEvaluator(planar_arm, context, dt, x_i, u_i, x_ip1, u_ip1, lambda_c_i, lambda_c_ip1):
  ...
  fi = EvaluateDynamics(planar_arm, context, x_i, u_i)
  fi1 = EvaluateDynamics(planar_arm, context, x_ip1, u_ip1)
  ...
  h_i = sdot_halfway - EvaluateDynamics(planar_arm, context, s_halfway, u_halfway, lambda_c_halfway)
