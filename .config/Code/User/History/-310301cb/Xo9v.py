...
class SE3Control(object):
    ...
    def __init__(self, quad_params):
        ...
        # STUDENT CODE HERE
        self.Kp = np.diag([7.5, 7.5, 35.0])*1.05*0.5
        self.Kd = np.diag([4.5,4.5,12.0/1.025])*0.5/1.025
        
        self.Kr = np.diag([11000, 11000, 2200.0])*0.4*0.5
        self.Kw = np.diag([335, 335, 200.0])*0.4*0.5
