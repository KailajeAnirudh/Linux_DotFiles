...
plt.hlines([steady_state_value, drone_y_positions.max()], [steady_state_time, timestamps_drone_y[np.argmax(drone_y_positions)]], [16], color = 'black', label = 'Steady state')
plt.vlines(4.87, 0, 0.8, colors = )
plt.xlabel('Time (s)')
