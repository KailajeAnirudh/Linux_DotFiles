...
plt.plot(timestamps_flat_x, flat_output_x_positions, 'r', label='Falt Output X Position')
plt.xlabel('Time (s)')
...
plt.plot(timestamps_flat_y, flat_output_y_positions, 'r', label='Falt Output Y Position')
plt.xlabel('Time (s)')
