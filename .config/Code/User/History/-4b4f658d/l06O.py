...
rise_time = timestamps_drone_y[np.argmin(drone_y_positions-0.9*0.5)]
plt.figure(figsize=(10, 5))
...
plt.vlines([steady_state_time, rise_time], [0, 0], [0.5, 0.5], colors = ['green', 'gray'], linestyles='dashed')
