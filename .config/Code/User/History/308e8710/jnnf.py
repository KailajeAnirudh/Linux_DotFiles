...
def dir_col(N, initial_state, jumpheight, tf, jumpheight_tol=5e-2):
  ...
  prog.SetSolverOption(SolverType.kSnopt, "Major iterations limit", 3e8) #30000
  # prog.SetSolverOption(SolverType.kSnopt, "Minor iterations limit", 300000) #30000
  prog.SetSolverOption(SolverType.kSnopt, "Minor feasibility tolerance", 1e-8)
  prog.SetSolverOption(SolverType.kSnopt, "Major optimality tolerance", 1e-1)
