...
plt.savefig('StereoPair_Unrectified.png', dpi=300)
plt.show()
...
plt.savefig('StereoPair1.png', dpi = 300)
plt.show()

plt.figure()
stereo_pair_2.display_matches()
plt.title('Stereo Pair 2')
plt.savefig('StereoPair2.png', dpi = 300)
plt.show()
...
plt.savefig('TemporalMatches.png', dpi = 300)
plt.show()
