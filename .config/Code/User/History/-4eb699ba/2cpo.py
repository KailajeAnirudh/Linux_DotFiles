...
ax.text(start[0]-0.5, start[1]-0.5, start[2]-1, f'Solve Time: {end_time-start_time:.2f}s', color='green')
ax.text(start[0]-0.5, start[1]-0.5, start[2]-1.5, f'Expanded Nodes: {node_expanded}', color='green')
plt.show()
print("Done")
