...
def AddCollocationConstraints(prog, planar_arm, context, N, x, u, lambda_c, lambda_c_col, timesteps):
  ...
  def CollocationConstraintHelper_1(vars):
      ...
      left_foot_z = planar_arm.CalcPointsPositions(context, 
                                                   planar_arm.GetBodyByName("left_lower_leg").body_frame(), np.array([0,0,-0.5]), 
      ...
      right_foot_z = planar_arm.CalcPointsPositions(context, 
                                                   ...
                                                   planar_arm.world_frame())
      prog.AddBoundingBoxConstraint(np.array([0,0]), np.array([1e-3, 1e-3]), np.array([left_foot_z, right_foot_z]))
