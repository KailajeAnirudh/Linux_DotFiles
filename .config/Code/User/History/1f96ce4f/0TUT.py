...
def AddAngularMometumConstraint(prog, robot, context, x, Lthd):

  def AngularMomentumHelper():
    pass

  prog.AddConstraint(AngularMomentumHelper, np.zeros(3)-Lthd/2, np.zeros(3)+Lthd/2, )  
