...
- The diagnostic subclass models generally perform better. Present performance (Validation AUCs):
    - FORM: 0.25
    - Rhythm: 0.32
    - MI: 0.55
    - STTC: 0.6
...
- Questiions to ask:
    - There are likelihood values given for each label, currently I'm using the BCELoss() with those likelihoods directly. 
