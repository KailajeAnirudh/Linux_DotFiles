...
class PhaseSwitch(LeafSystem):
    def __init__(self):
        ...
        self.preflight_trajectory_port_index = self.DeclareAbstractInputPort("preflight_Trajectory", traj_dim).get_index()
        self.aerial_trajectory_port_index = self.DeclareAbstractInputPort("Aerial_Trajectory", traj_dim).get_index()
        self.landing_trajectory_port_index = self.DeclareAbstractInputPort("Landing_Trajectory", traj_dim).get_index()
