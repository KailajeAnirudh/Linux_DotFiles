...
class PhaseSwitch(LeafSystem):
    def __init__(self, height, jump_time, x_traj):
        ...
        self.landingoutput_trajectory_port_index = self.DeclareAbstractOutputPort("OSCLanding_Trajectory", lambda: AbstractValue.Make(BasicVector(traj_dim)), self.PhaseOutput).get_index()
