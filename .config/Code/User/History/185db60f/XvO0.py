...
path  = '../'
X_train = np.load(f'/home/ubuntu/Anirudh/dataset/Datasets/{model_name}Train.npz')['x']
X_train = torch.from_numpy(np.transpose(X_train, (0, 2, 1))).float()
y_train = np.load(f'/home/ubuntu/Anirudh/dataset/Datasets/{model_name}Train.npz')['y']
X_test = np.load(f'/home/ubuntu/Anirudh/dataset/Datasets/{model_name}Val.npz')['x']
X_test = torch.from_numpy(np.transpose(X_test, (0, 2, 1))).float()
y_test = np.load(f'/home/ubuntu/Anirudh/dataset/Datasets/{model_name}Val.npz')['y']
