...
post_flight_traj_src = builder.AddSystem(ConstantValueSource(AbstractValue.Make(BasicVector(np.zeros(3,)))))
...
#COM wiring
print(z_height_desired.get_output_port().get_index(), preflight_planner.get_com_input_port())
builder.Connect(z_height_desired.get_output_port().get_index(), preflight_planner.get_com_input_port())
