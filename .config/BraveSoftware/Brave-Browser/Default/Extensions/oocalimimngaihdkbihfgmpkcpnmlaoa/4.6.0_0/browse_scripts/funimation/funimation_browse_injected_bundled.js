...
;// CONCATENATED MODULE: ./src/Teleparty/BrowseScripts/Funimation/funimation_browse_injected.js

function addNativePartyButton() {
    if (document.getElementById('native-party-button') != null) {
        return undefined;
    }
    const playButton = document.querySelector('a[data-test="content-hero__watch-cta"]');
    if (playButton == null) {
        return undefined;
    }
