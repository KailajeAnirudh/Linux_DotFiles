...
if (!window.videoIdScriptLoaded) {
    ...
    var findTitle = function () {
        try {
            ...
            const titlePath = elementRoot[key].return.return.stateNode.context.stores.adPlayback.player.ui.xrayController.controller.metricsFeature.mediaEventController.acquisitionMediaEventController.mpPlayer.primaryContentMpPlayer.contentSource.mediaRepresentation.dashMediaRepresentationContext.sourceUrlStore.activePlaybackConsumptionIdTracker.titleView.currentItem.catalogMetadata.catalog.id;
