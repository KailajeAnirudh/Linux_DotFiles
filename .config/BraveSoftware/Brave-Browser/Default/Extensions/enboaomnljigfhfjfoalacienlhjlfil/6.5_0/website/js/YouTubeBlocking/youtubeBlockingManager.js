(function() {
    ...
    function blockTemporaryYoutube(finishDate) {
        ...
        document.body.innerHTML = "<div id='youtubeBlockedBox'><div class='temporaryLockedIcon'></div><p class='temporaryLockedHeadline'>Access Denied</p><p class='temporaryLockedSubhedline'>" + stringToDisplay + "</p></div>";
    }
    ...
    function checkIfNeedToBlockWebsiteTemporary() {
        browser.storage.local.get([getConst.youtubeBlockingTemporaryIsActiveData,
            ...
            if (temporaryBlockingIsActive == true) {
                ...
                const shouldBlockExtension = obj[youtubeBlockingTemporaryBlockExtensionData];
