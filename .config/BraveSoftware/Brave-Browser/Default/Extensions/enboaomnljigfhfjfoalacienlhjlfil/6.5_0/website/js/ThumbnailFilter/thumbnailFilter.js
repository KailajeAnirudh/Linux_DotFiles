...
function setThumbnailFilters() {
    ...
    browser.storage.local.get([blurFilterId,
        ...
        styleElement.textContent = `
            html[untrap_is_desktop="true"][untrap_global_enable="true"] ytd-thumbnail img,
            
            html[untrap_is_desktop="true"][untrap_global_enable="true"] #thumbnail-container img,
            
            html[untrap_is_desktop="true"][untrap_global_enable="true"] ytd-playlist-thumbnail img,
            
            html[untrap_is_desktop="true"][untrap_global_enable="true"] ytd-hero-playlist-thumbnail-renderer img {
            
                filter: opacity(${opacityValue}) grayscale(${grayscaleValue}) blur(${blurValue}) !important;
            }
            
            html[untrap_is_mobile="true"][untrap_global_enable="true"] ytm-compact-playlist-renderer .media-item-thumbnail-container img,
            
            html[untrap_is_mobile="true"][untrap_global_enable="true"] .compact-media-item-image img,
            
            html[untrap_is_mobile="true"][untrap_global_enable="true"] .amsterdam-playlist-thumbnail-wrapper img,
            
            html[untrap_is_mobile="true"][untrap_global_enable="true"] ytm-video-with-context-renderer .media-item-thumbnail-container img,
            
            html[untrap_is_mobile="true"][untrap_global_enable="true"] ytm-compact-video-renderer .video-thumbnail-container-compact img,
            
            html[untrap_is_mobile="true"][untrap_global_enable="true"] ytm-channel-featured-video-renderer ytm-thumbnail-cover img {
